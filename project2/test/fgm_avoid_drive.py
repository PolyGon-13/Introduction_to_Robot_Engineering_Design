...
def main():
    ...
    try:
        while True:
            ...
            # 기본 명령 초기화
            # 핵심:
            # 벽 따라가기 기능이 켜져 있을 때만 FGM을 끈다.
            # 즉, wall_follow_active == True이면 choose_fgm_cmd()를 실행하지 않는다.
            # ============================================================
            v = 0.0
            w = 0.0
            target_angle = 0.0
            ...
            fgm_enabled = not wall_follow_active
            ...
            # ------------------------------------------------------------
            # 안전한 gap이 없으면 Recovery 회전 시작
            # 단, 벽 따라가기 중이면 Recovery를 새로 시작하지 않음
            # ------------------------------------------------------------
            if (
