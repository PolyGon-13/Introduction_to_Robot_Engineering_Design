...
COLLISION_DIST = ROBOT_RADIUS + 0.03 # 충돌위험 거리
...
FGM_GOAL_WEIGHT_SAFE = 0.00 # 안전할 때 목표 방향 가중치
FGM_GOAL_WEIGHT_DANGER = 0.00 # 위험할 때 목표 방향 가중치
...
SIDE_GAP_BIAS_MAX_DEG = 20.0 # 조향 보정 최대각도
