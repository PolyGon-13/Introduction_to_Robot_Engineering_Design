...
W_CANDIDATES = [-2.00, -1.50, -1.20, -0.90, -0.70, -0.50, -0.35, -0.20, -0.10, 0.0,
                0.10, 0.20, 0.35, 0.50, 0.70, 0.90, 1.20, 1.50, 2.00]
...
side_near_weight = 20.0
side_collision_weight = 40.0
forward_weight = 1.0
