...
W_CANDIDATES = [-0.65, -0.50, -0.35, -0.20, 0.0,
                0.20, 0.35, 0.50, 0.65]
...
DEAD_END_CLEARANCE_MARGIN = 0.06
DEAD_END_PENALTY_WEIGHT = 140.0

# 실제로 전방+좌우가 막혔을 때 제자리 회전 탈출
DEAD_END_FRONT_DIST = 0.55
DEAD_END_SIDE_DIST = COLLISION_DIST + 0.08
DEAD_END_ESCAPE_W = 0.75

# 벽과 장애물 사이 좁은 포켓 감지용
POCKET_SIDE_WALL_DIST = COLLISION_DIST + 0.22
POCKET_DIAGONAL_OBS_DIST = 0.62
POCKET_FRONT_IGNORE_DIST = 0.25
POCKET_MIN_W = 0.08
POCKET_PENALTY_WEIGHT = 95.0
POCKET_NEAR_WALL_WEIGHT = 8.0
POCKET_TURN_AWAY_BONUS = 6.0
